<template>
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="订单号" prop="dingdanhao">
					<el-input v-model="ruleForm.dingdanhao" placeholder="订单号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.dingdanhao" label="订单号" prop="dingdanhao">
					<el-input v-model="ruleForm.dingdanhao" placeholder="订单号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="离场时间" prop="lichangshijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.lichangshijian" label="离场时间" prop="lichangshijian">
					<el-input v-model="ruleForm.lichangshijian" placeholder="离场时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="本次停车时长" prop="bencitingcheshizhang">
					<el-input v-model="bencitingcheshizhang" placeholder="本次停车时长" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.bencitingcheshizhang" label="本次停车时长" prop="bencitingcheshizhang">
					<el-input v-model="ruleForm.bencitingcheshizhang" placeholder="本次停车时长" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'" label="停车费用" prop="bencitingchefeiyong">
					<el-input v-model="bencitingchefeiyong" placeholder="停车费用" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.bencitingchefeiyong" label="停车费用" prop="bencitingchefeiyong">
					<el-input v-model="ruleForm.bencitingchefeiyong" placeholder="停车费用" readonly></el-input>
				</el-form-item>
			</template>
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `tingchejiaofei/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.tingchejiaofeiCrossAddOrUpdateFlag = false;
											this.parent.search();
