	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="区域" prop="quyu">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.cheweitupian" label="车位图片" prop="cheweitupian">
					<file-upload
						tip="点击上传车位图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.cheweitupian" label="车位图片" prop="cheweitupian">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="车位数量" prop="cheweishuliang">
					<el-input v-model.number="ruleForm.cheweishuliang" placeholder="车位数量" clearable  :readonly="ro.cheweishuliang"></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="车位详情" prop="cheweixiangqing">
					<el-input
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}' v-else-if="ruleForm.cheweixiangqing" label="车位详情" prop="cheweixiangqing">
