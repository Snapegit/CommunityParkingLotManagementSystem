  ...
  <div :style='{"padding":"30px"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"width":"100%","margin":"0 0 20px 0"}'   v-if="flag=='yonghu'"  label="车牌号" prop="chepaihao">
  ...
  methods: {
    ...
    onUpdateHandler() {
      if((!this.ruleForm.yonghuzhanghao)&& 'yonghu'==this.flag){
        ...
        if(this.ruleForm.yonghuzhanghao && ((this.ruleForm.yonghuzhanghao).toString().length<5) && `yonghu` == this.flag){
            this.$message.error(`用户账号长度不能小于5`);
            return
        }

        if(this.ruleForm.yonghuzhanghao && ((this.ruleForm.yonghuzhanghao).toString().length>12) && `yonghu` == this.flag){
      ...
      if((!this.ruleForm.xingming)&& 'yonghu'==this.flag){
        ...
        if(this.ruleForm.xingming && ((this.ruleForm.xingming).toString().length<1) && `yonghu` == this.flag){
            this.$message.error(`姓名长度不能小于1`);
            return
        }

        if(this.ruleForm.xingming && ((this.ruleForm.xingming).toString().length>15) && `yonghu` == this.flag){
      ...
      if((!this.ruleForm.mima)&& 'yonghu'==this.flag){
        ...
        if(this.ruleForm.mima && ((this.ruleForm.mima).toString().length>15) && `yonghu` == this.flag){
