...
<div :style='{"width":"80%","padding":"20px","margin":"10px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="车位图片" v-if="type!='cross' || (type=='cross' && !ro.cheweitupian)" prop="cheweitupian">
            <file-upload
            tip="点击上传车位图片"
            action="file/upload"
            :limit="3"
            ...
            <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' class="upload" v-else label="车位图片" prop="cheweitupian">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="车位数量" prop="cheweishuliang">
            <el-input v-model.number="ruleForm.cheweishuliang" 
                placeholder="车位数量" clearable :disabled=" false  ||ro.cheweishuliang"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="车位详情" prop="cheweixiangqing">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="车位详情"
